--this file has been auto generated (from https://github.com/CapsAdmin/ffibuild/tree/master/steamworks)
...
local dPath = Game.basePath .. "/steam/"
...
do
	...
	if file then
		...
		local file, err = io.open(dPath .. "steam_appid.txt", "w")
		if file then
			file:write("480")
			io.close(file)
			appid = 480
...
steamworks.unifiedmessages_ptr = lib.SteamAPI_ISteamClient_GetISteamUnifiedMessages(steamworks.client_ptr, steamworks.steam_user_ptr, steamworks.pipe_ptr, 'STEAMUNIFIEDMESSAGES_INTERFACE_VERSION') --steamworks.client_ptr, steamworks.steam_user_ptr, steamworks.pipe_ptr, 'STEAMUNIFIEDMESSAGES_INTERFACE_VERSION002')
